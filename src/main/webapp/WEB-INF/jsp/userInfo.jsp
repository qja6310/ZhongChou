	...
	<form class="layui-form fm" id="form4">
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
				<input type="text" id="name" required lay-verify="required"
					placeholder="请输入姓名" autocomplete="off" class="layui-input" value="${user.name }"
					maxlength="16">
			</div>
		</div>
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
				<input type="text" id="age" required lay-verify="required" value="${user.age }"
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-block" id="sex">
				<input type="radio" name="sex" value="1" title="男" <c:if test="${user.sex == '1' }">checked</c:if>>
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
				<input type="text" id="phone" required lay-verify="required" value="${user.phone }"
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
				<input type="password" id="password" required lay-verify="required" value="${user.password }"
